...
canvas_closed = False  # Flag to track if sciantix_v2 window was closed
...
def sciantix_v2(file, is_main):
    # Define the sciantix_v2 function which accepts two parameters: the file to be processed and a flag indicating
...
def main():
    ...
    if 'output.txt' in os.listdir(os.getcwd()):
        # If the file exists, run the sciantix_v2 function with 'output.txt' as the filename and main flag.
        sciantix_v2('output.txt', is_main)
